...
export const FASCIAS = ['Akila', 'Nubia', 'Eugiene', 'Rebeka', 'Carmen', 'Sofia', 'Xena B', 'Xena A', 'Mandisa'];
...
export const ACCESSORIES = [
  { id: 'rack-t', name: 'Trouser Rack', icon: '📏', desc: 'Pull-out, fits 10–14 trousers, soft-close', price: 4500 },
  { id: 'jewel-g', name: 'Jewellery Tray (Glass)', icon: '💍', desc: 'Velvet-lined, glass cover shelf', price: 8500 },
  { id: 'acc-g', name: 'Accessory Tray (Glass)', icon: '🕶️', desc: 'Segmented, glass cover shelf', price: 7200 },
  { id: 'jewel-w', name: 'Jewellery Tray (Wood)', icon: '💎', desc: 'Velvet-lined, wooden cover shelf', price: 6500 },
  { id: 'acc-w', name: 'Accessory Tray (Wood)', icon: '⌚', desc: 'Segmented, wooden cover shelf', price: 5800 },
  { id: 'shoe', name: 'Shoe Rack Shelves', icon: '👟', desc: 'Angled fixed shelves for footwear', price: 2200 },
  { id: 'side', name: 'Side Hanger Rod', icon: '🧷', desc: 'Pull-out side rod, scarves & ties', price: 1800 },
  { id: 'top', name: 'Top Hanger Rod', icon: '👕', desc: 'Top-mounted garment rail', price: 1200 },
  { id: 'mirror', name: 'Mirror Panel', icon: '🪞', desc: 'Full-length door or fixed mirror', price: 4200 },
];
