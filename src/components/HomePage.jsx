...
import {
  ArrowRight, Layers, Ruler, CheckCircle, Zap, Users, Star,
  ChevronRight, Sparkles, Package, BarChart3, FileText,
} from 'lucide-react';
...
const Tag = ({ children }) => (
  <span style={{
    ...
    color: 'var(--accent)', fontSize: 12, fontWeight: 600, letterSpacing: '0.01em',
  }}>
    {children}
  </span>
);
...
const FeatureCard = ({ icon, title, desc, accent }) => {
  ...
  return (
    ...
    >
      ...
      <div>
        <h4 style={{ fontSize: 16, fontWeight: 700, color: 'var(--text-primary)', marginBottom: 6, letterSpacing: '-0.02em' }}>
          {title}
        </h4>
...
const StepItem = ({ num, title, desc }) => (
  <div style={{ display: 'flex', gap: 20 }}>
    ...
    <div>
      <h4 style={{ fontSize: 15, fontWeight: 700, color: 'var(--text-primary)', marginBottom: 4, letterSpacing: '-0.02em' }}>
        {title}
      </h4>
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', fontFamily: 'var(--font-sans)' }}>
      ...
      >
        ...
        <Tag><Sparkles size={11} /> AI-Powered Wardrobe Configurator</Tag>
        ...
        <p style={{
          ...
          Configure, customize, and get instant pricing — all in one place.
          Built for interior designers and sales professionals.
        </p>
        ...
        <div style={{
          ...
          <span style={{ marginLeft: 4 }}>Trusted by <strong style={{ color: 'var(--text-secondary)' }}>500+ designers</strong> across India</span>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              flex: 1, height: 22, background: 'var(--bg-secondary)',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
                ...
                <div style={{ height: 10, width: 80, background: 'var(--border-strong)', borderRadius: 3 }} />
              </div>
              {['Room Setup','Modules','Finishes','Quote'].map((s, i) => (
                <div key={s} style={{
                  ...
                  <div style={{
                    ...
                    background: i < 1 ? 'var(--accent)' : i === 1 ? 'var(--accent)' : 'var(--bg-tertiary)',
              ...
              <div style={{ marginTop: 'auto', padding: '14px 12px', background: 'var(--accent-light)', borderRadius: 8, border: '1px solid var(--accent-border)' }}>
                <div style={{ fontSize: 10, color: 'var(--accent)', fontWeight: 600, marginBottom: 3 }}>TOTAL PRICE</div>
                <div style={{ fontSize: 18, fontWeight: 800, color: 'var(--accent)', letterSpacing: '-0.03em' }}>₹48,500</div>
              </div>
            </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12 }}>
                {[
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{
                      height: 60, background: m.sel ? 'var(--accent-light)' : 'var(--bg-tertiary)',
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                    }}>
                      <Package size={20} color={m.sel ? 'var(--accent)' : 'var(--text-muted)'} />
                    </div>
                    <div style={{ padding: '8px 10px' }}>
                      <div style={{ fontSize: 10, fontWeight: 700, color: 'var(--text-primary)', marginBottom: 1 }}>{m.name}</div>
                      <div style={{ fontSize: 9, color: 'var(--text-muted)' }}>{m.w}</div>
                      <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--accent)', marginTop: 4 }}>{m.price}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--text-primary)', marginBottom: 4 }}>Your Config</div>
              ...
              <div style={{ marginTop: 'auto' }}>
                <div style={{ height: 5, background: 'var(--bg-tertiary)', borderRadius: 99, overflow: 'hidden', marginBottom: 4 }}>
                ...
                <div style={{ fontSize: 9, color: 'var(--text-muted)', display: 'flex', justifyContent: 'space-between' }}>
                  <span>2100mm</span><span>72%</span>
                </div>
              </div>
              <div style={{
                background: 'var(--accent)', borderRadius: 8, padding: '10px',
                textAlign: 'center',
              }}>
                <div style={{ fontSize: 9, color: 'rgba(255,255,255,0.7)', fontWeight: 600 }}>TOTAL</div>
                <div style={{ fontSize: 16, fontWeight: 800, color: 'white', letterSpacing: '-0.03em' }}>₹48,500</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            ...
            <button
              ...
              style={{
                ...
                cursor: 'pointer', fontFamily: 'var(--font-sans)',
                boxShadow: 'var(--shadow-md)', transition: 'background 0.15s',
              }}
              onMouseEnter={e => (e.currentTarget.style.background = 'var(--accent-hover)')}
              onMouseLeave={e => (e.currentTarget.style.background = 'var(--accent)')}
            >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
            <StepItem num={1} title="Enter room dimensions" desc="Set the width, height, and depth of your wardrobe alcove." />
            <StepItem num={2} title="Pick your modules" desc="Browse and add from the full catalogue. The system tracks every mm." />
            <StepItem num={3} title="Choose finishes & hardware" desc="Select material grade, colour tone, handles, and lighting." />
            <StepItem num={4} title="Download your quote" desc="Export a professional PDF instantly — no back-and-forth needed." />
          </div>
        </div>
      </section>
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          letterSpacing: '-0.04em', color: 'var(--text-primary)', marginBottom: 14,
        }}>
          Ready to design your wardrobe?
        </h2>
        <p style={{ fontSize: 15, color: 'var(--text-secondary)', marginBottom: 36, maxWidth: 420, lineHeight: 1.65 }}>
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--text-primary)', letterSpacing: '-0.02em' }}>NirmanBook</span>
